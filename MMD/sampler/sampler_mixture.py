...
def sampler_mixture(
    ...
    for the first two dimesnions and zeros for the other dimensions,
    ...
    X = jnp.random.permutation(subkeys[5], X, axis=0) 
    ...
    Y = jnp.random.permutation(subkeys[5], Y, axis=0) 
